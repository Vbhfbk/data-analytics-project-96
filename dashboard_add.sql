...
--11. Каналы привлечения (по модели last paid click)
with t as (
    select distinct on (s.visitor_id)
        s.visitor_id,
        s.visit_date,
...
--12. Работа каналов привлечения в течение месяца (по модели last paid click)
with t as (
    select distinct on (s.visitor_id)
        s.visitor_id,
        s.visit_date,
...
--14. Работа каналов привлечения в течение недели (по модели last paid click)
with t as (
    select distinct on (s.visitor_id)
        s.visitor_id,
        s.visit_date,
...
--15. Работа каналов привлечения по неделям в течение месяца (по модели last paid click)
with t as (
    select distinct on (s.visitor_id)
        s.visitor_id,
        s.visit_date,
